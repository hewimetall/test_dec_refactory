...
START_TEST(short_div) {
  ...
  s21_decimal dec2 = {{2, 0, 0}, {{0, 0, 0, 0}}};
  s21_decimal ans = DECIMAL_ZERO;
  s21_decimal true_ans = {{32768, 0, 0}, {{0, 0, 0, 0}}};
...
START_TEST(basic_div_2) {
  ...
  s21_decimal dec2 = {{9, 0, 0}, {{0, 1, 0, 0}}};
  s21_decimal ans = DECIMAL_ZERO;
...
START_TEST(basic_div_3) {
  ...
  true_ans.data[1] = 1621842184;
  true_ans.data[2] = 843268356;
  true_ans.head.flags = 1835008 + MINUS_SIGN;
...
START_TEST(result_too_small) {
  s21_decimal dec1 = {{1, 0, 0}, {{0, 0, 0, 0}}};
...
START_TEST(big_values_div_2) {
  s21_decimal dec1 = {{4294967295, 4294967295, 4294967295}, {{0, 0, 0, 0}}};
  s21_decimal dec2 = {{4294967295, 4294967295, 4294967295}, {{0, 0, 0, 0}}};
  s21_decimal ans = DECIMAL_ZERO;
  s21_decimal true_ans = {{1, 0, 0}, {{0, 0, 0, 0}}};
