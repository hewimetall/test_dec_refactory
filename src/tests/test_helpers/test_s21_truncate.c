...
//   s21_decimal dec1;
//   dec1.data[0] = 0b00000000000000000000000011010011;  // 21.1
...
//   s21_decimal result;
//   result.data[0] = 0b00000000000000000000000000010101;  // 21
...
//   dec1.data[1] = 0b11111111111111111111111111111111;
//   dec1.data[2] = 0b11111111111111111111111111111111;
//   dec1.head.flags = 0b00000000000000010000000000000000;
//   s21_decimal result;
//   result.data[0] =
//       0b10011001100110011001100110011001;  // 7922816251426433759354395033.5
//   result.data[1] = 0b10011001100110011001100110011001;
//   result.data[2] = 0b00011001100110011001100110011001;
//   result.head.flags = 0b00000000000000000000000000000000;
//   s21_decimal res1;
//   s21_truncate(dec1, &res1);
//   ck_assert_int_eq(res1.data[0], result.data[0]);
